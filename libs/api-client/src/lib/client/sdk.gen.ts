...
export class ApiSdk extends HeyApiClient {
     ...
     * Regenerate Shoutout Draft
     */
    public regenerateShoutoutDraft<ThrowOnError extends boolean = false>(options: Options<RegenerateShoutoutDraftData, ThrowOnError>): RequestResult<RegenerateShoutoutDraftResponses, RegenerateShoutoutDraftErrors, ThrowOnError> {
